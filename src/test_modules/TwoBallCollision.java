 ...
 *
 */
public class TwoBallCollision extends JFrame{
	...
	public TwoBallCollision(Ball initB0, Ball initB1){
		//s0 = initS0;
		//s1 = initS1;
	...
	public static void main(String [] args){
		...
		ball0.setRadius(60);
		Ball ball1 = new Ball(200, 200, 0, 60, Color.RED);
		ball1.setRadius(30);
		TwoBallCollision is3 = new TwoBallCollision(ball0, ball1);
	}
